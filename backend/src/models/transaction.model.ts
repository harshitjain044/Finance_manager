...
import { convertToMajorUnit, convertToMinorUnit } from "../utils/format-currency";
...
const transactionSchema = new Schema<TransactionDocument>(
  {
    ...
    amount: {
      type: Number,
      required: true,
      set: (value: number) => convertToMinorUnit(value),
      get: (value: number) => convertToMajorUnit(value),
    },

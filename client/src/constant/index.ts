...
export const PAYMENT_METHODS = [
  ...
  { value: PAYMENT_METHODS_ENUM.BANK_TRANSFER, label: "Bank Transfer / NEFT / IMPS" },
  { value: PAYMENT_METHODS_ENUM.MOBILE_PAYMENT, label: "UPI / Mobile Payment" },
  { value: PAYMENT_METHODS_ENUM.AUTO_DEBIT, label: "Auto Debit / ECS" },
